...
public static class ProfileTools
{
    ...
    public static Task<UserProfileDto> get_user_profile(UserProfileService service, CancellationToken ct = default)
        => service.GetAsync(ct);
    ...
    public static Task<UserProfileDto> update_user_profile(UpdateUserProfileRequest request, UserProfileService service, CancellationToken ct = default)
